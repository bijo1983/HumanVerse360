-- SECURITY DEFINER function so it runs as the owner (postgres) and bypasses RLS.
-- Called from the browser immediately after supabase.auth.signUp() succeeds.
...
BEGIN
  ...
  INSERT INTO companies (
    ...
    'active', CURRENT_DATE, v_user_id
  )
  RETURNING * INTO v_company;

  -- Link user as admin
  INSERT INTO company_users (company_id, user_id, full_name, email, role)
  VALUES (v_company.id, v_user_id, p_full_name, p_email, 'admin');
