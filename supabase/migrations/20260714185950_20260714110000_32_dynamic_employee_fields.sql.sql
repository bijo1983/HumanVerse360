...
VALUES
  ('BH',
   '[{"key":"flat","label":"Flat","display_order":1},{"key":"building","label":"Building","required":true,"display_order":2},{"key":"road","label":"Road","display_order":3},{"key":"block","label":"Block","required":true,"validation":{"regex":"^[0-9]{3,4}$"},"display_order":4},{"key":"governorate","label":"Governorate","type":"select","options":["Capital","Muharraq","Northern","Southern"],"display_order":5}]',
   'Flat {{flat}}, Bldg {{building}}, Road {{road}}, Block {{block}}, {{governorate}}'),
  ('AE',
   '[{"key":"emirate","label":"Emirate","type":"select","required":true,"options":["Abu Dhabi","Dubai","Sharjah","Ajman","Umm Al Quwain","Ras Al Khaimah","Fujairah"],"display_order":1},{"key":"area","label":"Area","display_order":2},{"key":"street","label":"Street","display_order":3},{"key":"building","label":"Building","display_order":4},{"key":"po_box","label":"PO Box","display_order":5}]',
   '{{building}}, {{street}}, {{area}}, {{emirate}}, PO Box {{po_box}}'),
  ('SA',
   '[{"key":"region","label":"Region","display_order":1},{"key":"city","label":"City","required":true,"display_order":2},{"key":"district","label":"District","display_order":3},{"key":"street","label":"Street","display_order":4},{"key":"building_number","label":"Building Number","validation":{"regex":"^[0-9]{4}$"},"display_order":5},{"key":"postal_code","label":"Postal Code","validation":{"regex":"^[0-9]{5}$"},"display_order":6}]',
   '{{building_number}} {{street}}, {{district}}, {{city}} {{postal_code}}, {{region}}'),
  ('OM',
   '[{"key":"governorate","label":"Governorate","display_order":1},{"key":"wilayat","label":"Wilayat","display_order":2},{"key":"way","label":"Way","display_order":3},{"key":"building","label":"Building","display_order":4},{"key":"postal_code","label":"Postal Code","validation":{"regex":"^[0-9]{3}$"},"display_order":5}]',
   'Bldg {{building}}, Way {{way}}, {{wilayat}}, {{governorate}} {{postal_code}}'),
  ('QA',
   '[{"key":"zone","label":"Zone","display_order":1},{"key":"street","label":"Street","display_order":2},{"key":"building","label":"Building","display_order":3},{"key":"unit","label":"Unit","display_order":4},{"key":"po_box","label":"PO Box","display_order":5}]',
   'Bldg {{building}}, Street {{street}}, Zone {{zone}}, PO Box {{po_box}}'),
  ('KW',
   '[{"key":"governorate","label":"Governorate","type":"select","options":["Al Asimah","Hawalli","Farwaniya","Mubarak Al-Kabeer","Ahmadi","Jahra"],"display_order":1},{"key":"area","label":"Area","display_order":2},{"key":"block","label":"Block","display_order":3},{"key":"street","label":"Street","display_order":4},{"key":"building","label":"Building","display_order":5}]',
   'Bldg {{building}}, Street {{street}}, Block {{block}}, {{area}}, {{governorate}}'),
  ('IN',
   '[{"key":"address_line1","label":"Address Line 1","required":true,"display_order":1,"width":"full"},{"key":"address_line2","label":"Address Line 2","display_order":2,"width":"full"},{"key":"city","label":"City","required":true,"display_order":3},{"key":"district","label":"District","display_order":4},{"key":"state","label":"State","type":"select","required":true,"options":["Andhra Pradesh","Arunachal Pradesh","Assam","Bihar","Chhattisgarh","Goa","Gujarat","Haryana","Himachal Pradesh","Jharkhand","Karnataka","Kerala","Madhya Pradesh","Maharashtra","Manipur","Meghalaya","Mizoram","Nagaland","Odisha","Punjab","Rajasthan","Sikkim","Tamil Nadu","Telangana","Tripura","Uttar Pradesh","Uttarakhand","West Bengal","Delhi","Chandigarh","Puducherry","Jammu & Kashmir","Ladakh"],"display_order":5},{"key":"pin_code","label":"PIN Code","required":true,"validation":{"regex":"^[0-9]{6}$"},"display_order":6}]',
   '{{address_line1}}, {{address_line2}}, {{city}}, {{district}}, {{state}} {{pin_code}}'),
  ('GB',
   '[{"key":"address_line1","label":"Address Line 1","required":true,"display_order":1,"width":"full"},{"key":"address_line2","label":"Address Line 2","display_order":2,"width":"full"},{"key":"town_city","label":"Town / City","required":true,"display_order":3},{"key":"county","label":"County","display_order":4},{"key":"post_code","label":"Post Code","required":true,"validation":{"regex":"^[A-Za-z]{1,2}[0-9][A-Za-z0-9]? ?[0-9][A-Za-z]{2}$"},"display_order":5}]',
   '{{address_line1}}, {{address_line2}}, {{town_city}}, {{county}} {{post_code}}'),
  ('US',
   '[{"key":"address_line1","label":"Address Line 1","required":true,"display_order":1,"width":"full"},{"key":"address_line2","label":"Address Line 2","display_order":2,"width":"full"},{"key":"city","label":"City","required":true,"display_order":3},{"key":"state","label":"State","type":"select","required":true,"options":["AL","AK","AZ","AR","CA","CO","CT","DE","DC","FL","GA","HI","ID","IL","IN","IA","KS","KY","LA","ME","MD","MA","MI","MN","MS","MO","MT","NE","NV","NH","NJ","NM","NY","NC","ND","OH","OK","OR","PA","RI","SC","SD","TN","TX","UT","VT","VA","WA","WV","WI","WY"],"display_order":4},{"key":"zip","label":"ZIP Code","required":true,"validation":{"regex":"^[0-9]{5}(-[0-9]{4})?$"},"display_order":5},{"key":"county","label":"County","display_order":6}]',
