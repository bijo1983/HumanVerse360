...
-- Free the hardcoded document type list (was CHECK ... IN ('Passport','Visa','CPR',...))
...
CREATE TABLE IF NOT EXISTS country_document_requirements (
  ...
  applicable_when    jsonb,          -- e.g. {"field":"nationality_class","operator":"neq","value":"Bahraini"}
  hint               text,
...
-- Link uploaded documents back to the requirement they satisfy
